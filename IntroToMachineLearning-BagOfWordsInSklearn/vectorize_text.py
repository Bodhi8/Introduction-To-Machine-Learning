...
print('\nBegin vectorize_text.py Python module')
...
# files from_sara.txt, and from_chris.txt are in the src folder 
...
# $ head from_sara.txt - A list of pathnames to the actual emails, actaul data, path names are in from_sara.txt 
...
temp_counter = 0 # used for development - look through fewer emails - goes faster 

from_sara.seek(0) # previously iterated through file - TextIOWrapper - back to beginning of file 
...
# for name, from_person in [("sara", from_sara)]:
    ...
    for path in from_person:
        ...
        # if temp_counter < 30: # FIX
            # print("path -")
            # print(path)
            # maildir/germany-c/_sent_mail/1022.
            # print(len(path))
            ...
            # remove outlier words here identified in find_signature.py 
            # remove words with a high myDecisionTreeClassifier.feature_importances_ of interest
            ### use str.replace() to remove any instances of the words
            ### ["sara", "shackleton", "chris", "germani"]
            # remove_words = ["sara", "shackleton", "chris", "germani"]
            # remove_words = ["sara", "shackleton", "chris", "germani"]
            # add  "sshacklensf" - identified as an outlier in find_signature.py
            ...
            # add "sshacklensf"
            # stop_words_local = ["sara", "shackleton", "chris", "germani", "sshacklensf"]
            # stop_words_local = ["sara", "shackleton", "chris", "germani", "sshacklensf"]
            ...
            #      12 
            # instructions said do it this way - DO IT THIS WAY!!
...
vectorizer = TfidfVectorizer(stop_words = 'english') # *** sklearn *** stop_words - do it this way!! 
...
# *** not here see find_signature.py ***
...
print('\nEnd vectorize_text.py Python module\n')
